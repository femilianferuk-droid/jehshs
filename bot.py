                ...
                if update.message.photo:
                    ...
                    if purchase:
                        ...
                        caption = (
                            ...
                            f"Пользователь: @{user[1] if user else 'N/A'}\n"
                            f"Страна: {purchase[2]}\n"
                            f"Сумма: {purchase[3]}₽"
                        )
    ...
    # === ИСПРАВЛЕННЫЕ КНОПКИ "ПОЛУЧИТЬ НОМЕР" И "ПОЛУЧИТЬ КОД" ===
        ...
        if purchase[3] == "approved":
            ...
            admin_message = (
                ...
                f"🌍 Страна: {purchase[2]}\n"
                f"💰 Сумма: {purchase[3]}₽\n\n"
                f"✏️ Ответьте на это сообщение номером телефона"
            )
            ...
            try:
                ...
                logger.info(f"✅ Пользователь уведомлен о отправке запроса")
        ...
        if purchase[3] == "approved":
            ...
            admin_message = (
                ...
                f"🌍 Страна: {purchase[2]}\n"
                f"💰 Сумма: {purchase[3]}₽\n\n"
                f"✏️ Ответьте на это сообщение кодом"
            )
            ...
            if purchase:
                ...
                if "ЗАПРОС НОМЕРА" in reply_text:
                    ...
                    try:
                        ...
                        await update.message.reply_text(f"✅ Номер отправлен покупателю.")
                    ...
                    try:
                        ...
                        await update.message.reply_text(f"✅ Код отправлен покупателю.")
