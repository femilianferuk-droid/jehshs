...
def create_main_keyboard():
    ...
    keyboard = [
        ...
        [KeyboardButton("💳 Пополнить баланс"), KeyboardButton("🎫 Промокод")],
...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        welcome_text = (
            ...
            "💳 Пополнить баланс - пополните баланс от 100₽\n"
...
async def show_deposit_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if hasattr(update, 'callback_query'):
        await update.callback_query.message.edit_text(deposit_text, reply_markup=reply_markup, parse_mode='Markdown')
    else:
...
async def handle_deposit_amount(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await process_deposit(query, context, amount)
