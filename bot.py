...
# KOHФИГУРАЦИЯ
# ================================================================
TOKEN = "8244265951:AAESPS6P-Yekbis_CkwvD4vpOts0IL9MxuA"
ADMIN_ID = 7973988177
...
PRICES = [
    ...
    {"code": "+30", "country": "Треция", "price": 175, "emoji": "📞"},
    ...
    {"code": "+40", "country": "Румьния", "price": 80, "emoji": "📞"},
    ...
    {"code": "+55", "country": "Бразилия", "price": 125, "emoji": "🚠️"},
    {"code": "+57", "country": "Колумбия", "price": 75, "emoji": "🚠️"},
    {"code": "+62", "country": "Индонезия", "price": 50, "emoji": "🚠️"},
    {"code": "+84", "country": "Вьетнам", "price": 70, "emoji": "🚠️"},
    {"code": "+86", "country": "Китай", "price": 750, "emoji": "🚠️"},
    {"code": "+90", "country": "Турция", "price": 100, "emoji": "🚠️"},
    {"code": "+91", "country": "Индия", "price": 40, "emoji": "🚠️"},
    {"code": "+92", "country": "Пакистан", "price": 70, "emoji": "🚠️"},
    {"code": "+93", "country": "Афганистан", "price": 75, "emoji": "🚠️"},
    {"code": "+94", "country": "Щри-Ланка", "price": 100, "emoji": "🚠️"},
    {"code": "+95", "country": "Мьянма", "price": 35, "emoji": "🚠️"},
    {"code": "+98", "country": "Иран", "price": 175, "emoji": "🚠️"},
    {"code": "+212", "country": "Марокко", "price": 75, "emoji": "🚠️"},
    {"code": "+225", "country": "Кот-д'Ивуар", "price": 750, "emoji": "🚠️"},
    {"code": "+233", "country": "Гана", "price": 550, "emoji": "🚠️"},
    {"code": "+234", "country": "Нигерия", "price": 45, "emoji": "🚠️"},
    {"code": "+254", "country": "Кения", "price": 40, "emoji": "🚠️"},
    {"code": "+373", "country": "Молдова", "price": 175, "emoji": "🚠️"},
    {"code": "+374", "country": "Армения", "price": 400, "emoji": "🚠️"},
    {"code": "+375", "country": "Беларусь", "price": 170, "emoji": "🚠️"},
    {"code": "+380", "country": "Украина", "price": 235, "emoji": "🚠️"},
]
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text == "📞 Купить аккаунт":
        ...
        await update.message.reply_text(
            "По всем вопросам обращайтесь к поддержке: https://t.me/starfizovo/",
            reply_markup=get_main_keyboard()
        )
...
def main():
    ...
    print(f"🔐 Команда для админа: /admin")
    print("=" * 60)
    print("✨ ФИКСЫ В ЭТОЙ ВЕРСИИ:")
    print("  1. ✅ Кнопка 'Получить номер' - РАБОТАЕТ")
    print("  2. ✅ Кнопка 'Получить код' - РАБОТАЕТ")
    print("  3. ✅ Сообщения админу отправляются корректно")
    print("  4. ✅ Ответы админа доставляются покупателям")
    print("  5. ✅ Подробное логирование всех действий")
    print("=" * 60)
