...
Исправленная версия без ошибок редактирования сообщений
"""
...
async def approve_purchase(query, data):
    ...
    try:
        ...
        # Отправляем новое сообщение админу вместо редактирования
        await query.message.reply_text(
...
def main():
    ...
    print("2. Пользователь: отправляет скриншот")
    print("3. Админ: получает уведомление с кнопками ✅ Одобрить / ❌ Отклонить")
    print("4. Админ: нажимает ✅ Одобрить")
    print("5. Пользователь: получает уведомление с кнопками 📱 Получить номер и 🔢 Получить код")
    print("6. Пользователь: нажимает 📱 Получить номер -> Админ получает запрос")
    print("7. Админ: отвечает на запрос номером -> Пользователь получает номер")
    print("8. Пользователь: нажимает 🔢 Получить код -> Админ получает запрос")
    print("9. Админ: отвечает на запрос кодом -> Пользователь получает код")
    print("=" * 60)
